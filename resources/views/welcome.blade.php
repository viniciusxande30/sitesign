...
<html class="no-js" lang="zxx">
    <head>
        ...
        <title>Sign Audit & Advisory</title>
                        ...
                        <div class="col-lg-8 col-md-8 d-none  d-md-block">
                            <div class="header-cta">
                                <ul>                                   
                                    <li>
                                        <div class="text">
                                             <i class="fal fa-map-marker-check"></i> <div class="box"><strong>Rua Helena, 285 Cjs. 43/45</strong>  - Vila Olimpia - SP</div>
                                        </div>
                                      
                                    </li>
                                     <li>
                                           <div class="text">
                                             <i class="far fa-phone-alt"></i> <div class="box"><strong>Fone</strong>+55(11) 2638-9710</div>
                                        </div>
                                      
                                    </li>
                                    <li>
                                         <div class="text">
                                             <i class="fal fa-clock"></i><div class="box"><strong>E-mail</strong> contato@signadvisory.com.br</div>
                                        </div>
...
Better Solution</h2>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 col-sm-6">
                            <div class="single-counter text-center mt-30 mb-30 wow fadeInUp animated" data-animation="fadeInDown animated" data-delay=".2s">
            ...
            <!-- about-area -->
            <section id="about" class="about-area about-p pt-120 p-relative">
                         ...
                         <div class="col-lg-6 col-md-12 col-sm-12 pr-30">
                            <div class="about-content s-about-content  wow fadeInRight  animated" data-animation="fadeInRight" data-delay=".4s">
                                <div class="about-title second-title pb-25">
                                    <h2>Trabalhamos a mais de <span>25 anos </span> no mercado com auditoria </h2>   
                    ...
                    <div class="row">   
                        <div class="col-lg-12 p-relative">
                            <div class="section-title center-align mb-50 text-center">
                               ...
                               <p>Com o objetivo de auxiliar os tomadores de decisão na escolha da melhor estratégia, implementando ações com qualidade e excelência.</p>
                            </div>
                        </div>                        
            ...
            <!-- features-area -->
            <section id="graph" class="features-area pt-120 pb-120"  style="background:url('{{url('/')}}/assets/img/bg/features-lg-img.png')">
                <div class="container">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-12">
                            <div class="section-title cta-title  mb-20"> 
                                ...
                                <h2>Se Interessou Pelos Nossos Serviços?</h2>
                            </div>
                    ...
                    <div class="row">   
                        <div class="col-lg-12 p-relative">
                            <div class="section-title center-align mb-50 text-center">
                                ...
                                <h2>Principais Executivos</h2>
                               <p>Saiba quem São os Idealizadores da Sign Audit & Advisory</p>
                            </div>
                        </div>                        
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="single-team text-center mb-30 ">
                                <div class="team-thumb">
                                  <div class="brd">
                                        <img src="{{url('/')}}/assets/img/team/team_img01.png" alt="img" height="300px">
                                    </div>
                                </div>
                                <div class="team-info">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-team text-center mb-30 ">
                                <div class="team-thumb">
                                    <div class="brd">
                                         <img src="{{url('/')}}/assets/img/team/team_img02.png" alt="img"  height="300px">
                                    </div>
                                </div>
                                <div class="team-info">
            ...
            <!-- testimonial-area -->
            <section class="testimonial-area pt-120 pb-120" style="background-color: #eff5ff;">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-title center-align mb-50 text-center">
                                ...
                                <p>Como nossos clientes avaliam a Sign Audit & Advisory?</p>
                            </div>
                        ...
                        <div class="col-lg-7 col-md-12">
                            <div class="faq-wrap">
                                ...
                                <h2>
                                 ...
                                 <p>Saiba mais sobre as principais dúvidas sobre nosso trabalho</p>
                            ...
                            <div class="col-lg-12">                               
                                <div class="contact-field p-relative c-option mb-15">                                   
                                    <select name="services" id="sr">
                                      ...
                                      <option value="facil-therophy">Consultoria</option>
                                      <option value="hot-stone-message">Consultoria de RH</option>
                                      <option value="facil-therophy">BPS</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="contact-field p-relative c-message mb-30">                                  
                                    <textarea name="message" id="message" cols="30" rows="10" placeholder="Escreva o que você precisa"></textarea>
                                </div>
            ...
            <!-- contact-area-end -->
             ...
             <!-- brand-area -->
            <div class="brand-area pt-60 pb-60" style="background: #23292e;">
                <div class="container">
                    <div class="row brand-active">
                        <div class="col-xl-3">
                            <div class="single-brand">
                                <img src="{{url('/')}}/assets/img/brand/client_icon_1.png" alt="img">
                            </div>
                        </div>
                        <div class="col-xl-3">
                            <div class="single-brand">
                                    <img src="{{url('/')}}/assets/img/brand/client_icon_2.png" alt="img">
                            </div>
                        </div>
                        <div class="col-xl-3">
                            <div class="single-brand">
                                  <img src="{{url('/')}}/assets/img/brand/client_icon_3.png" alt="img">
                            </div>
                        </div>
                        <div class="col-xl-3">
                            <div class="single-brand">
                                     <img src="{{url('/')}}/assets/img/brand/client_icon_4.png" alt="img">
                            </div>
                        </div>
                         <div class="col-xl-3">
                            <div class="single-brand">
            ...
            <section id="blog" class="blog-area  p-relative pt-120 pb-90 fix">
                   <div class="ab-ani2"><img src="{{url('/')}}/assets/img/bg/p-shape02.png" alt="ab-ani-01.png"></div>
                <div class="ab-ani3"><img src="{{url('/')}}/assets/img/bg/p-shape02.png" alt="ab-ani-01.png"></div>
                <div class="container">
                    <div class="row align-items-center"> 
                        <div class="col-lg-12">
                            <div class="section-title center-align mb-50 text-center">
                                ...
                                <h2>
                                 ...
                                 <p>Saiba sobre as novidades de nosso ramo neste blog redigido por especialistas em auditoria</p>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="single-post2 mb-30  wow fadeInDown  animated">
                                <div class="blog-thumb2">
                                    <a href="blog-details.html"><img src="{{url('/')}}/assets/img/blog/inner_b1.jpg" alt="img"></a>
                                ...
                                <div class="blog-content2">     
                                    <div class="b-meta">
                                        <div class="row">
                                             ...
                                             <div class="meta-info">
                                                <ul>
                                                    ...
                                                    <li><i class="fal fa-calendar-alt"></i> 01 de outubro de 2023</li>
                                     ...
                                     <div class="row">
                                        <div class="col-lg-12">
                                         <h4><a href="blog-details.html">Título do Artigo 01</a></h4>    
                                       ...
                                       <div class="row align-items-center">
                                            <div class="col-lg-12 col-md-12">
                                               <div class="blog-btn"><a href="blog-details.html"><i class="fas fa-angle-right"></i> Saiba Mais</a></div>
                                             </div>
                                         </div>
        ...
        <footer class="footer-bg footer-p">
                          ...
                          <div class="col-xl-4 col-lg-4 col-sm-6">
                            <div class="footer-widget mb-30">
                                <div class="f-widget-title mb-30">
                                   <img src="{{url('/')}}/assets/img/logo/f_logo.png" alt="img">
                                </div>
                                <div class="f-contact">
                                    <ul>
                                    <li>
                                        <i class="icon fal fa-phone"></i>
                                        <span>+55(11) 2638-9710</span>
                                    </li>
                                   <li><i class="icon fal fa-envelope"></i>
                                        <span>
                                       <a href="mailto:contato@signadvisory.com.br">contato@signadvisory.com.br</a>
                                       </span>
                                    </li>
                                    <li>
                                        <i class="icon fal fa-map-marker-check"></i>
                                        <span>Rua Helena, 285 Cjs. 43/45<br> - Vila Olimpia - SP</span>
                                    </li>
            ...
            <div class="copyright-wrap">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">                         
                               Copyright  © 2023 Sign Audit & Advisory. Todos os Direitos Reservados.                       
                        </div>
